...
const content = [
  {
    title: "Let's create.",
    bg: colors.palette.lime,
    fontColor: colors.palette.pink,
  },
  {
    title: "Let's brainstorm.",
    bg: colors.palette.brown,
    fontColor: colors.palette.sky,
  },
  {
    title: "Let's discover.",
    bg: colors.palette.orange,
    fontColor: colors.palette.blue,
  },
  {
    title: "Let's go.",
    bg: colors.palette.teal,
    fontColor: colors.palette.yellow,
  },
  {
    title: 'ChatGPT.',
